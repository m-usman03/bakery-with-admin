      ...
      <div class="rd-navbar-aside-outer">
        <div class="rd-navbar-aside">
          ...
          <div class="rd-navbar-panel">
            ...
            <!-- RD Navbar Brand-->
            <div class="rd-navbar-brand"><a class="brand" href="index.html"><img class="brand-logo-dark" src="{{asset('images/logo-default-231x49.png')}}" alt="" width="231" height="49" srcset="{{asset('images/logo-default-231x49.png 2x')}}" /><img class="brand-logo-light" src="{{asset('images/logo-inverse-231x49.png')}}" alt="" width="231" height="49" srcset="{{asset('images/logo-inverse-231x49.png 2x')}}" /></a>
            </div>
          </div>
        ...
        <div class="rd-navbar-main">
              ...
              <li class="rd-nav-item"><a class="rd-nav-link" href="#">Elements</a>
                ...
                <ul class="rd-menu rd-navbar-megamenu">
                  ...
                  <li class="rd-megamenu-item rd-megamenu-banner">
                    <div class="rd-megamenu-title"><span class="rd-megamenu-icon mdi mdi-cake-variant"></span><span class="rd-megamenu-text">Welcome to Our Store</span></div><a class="banner-classic" href="grid-shop.html"><img src="{{asset('images/banner-1-300x202.jpg')}}" alt="" width="300" height="202" /></a>
                  </li>
                </ul>
              </li>
              <li class="rd-nav-item"><a class="rd-nav-link" href="contact-us.html">Contact Us</a>
              </li>
              <li class="rd-nav-item"><a class="rd-nav-link" href="{{route('product.list')}}">Products</a>
              </li>
            </ul>
          </div>
          <div class="rd-navbar-main-element">
            ...
            <div class="rd-navbar-basket-wrap">
              <button class="rd-navbar-basket fl-bigmug-line-shopping202" data-rd-navbar-toggle=".cart-inline"><span>{{count($cartItems)}}</span></button>
              <div class="cart-inline">
                <div class="cart-inline-header">
                  <h5 class="cart-inline-title">In cart:<span> {{count($cartItems) }}</span> Products</h5>
                ...
                <div class="cart-inline-body">
                  ...
                  <div class="cart-inline-item">
                    <div class="unit unit-spacing-sm align-items-center">
                      <div class="unit-left">
                        <a class="cart-inline-figure" href="{{ route('product.detail', $item['slug']) }}">
                          <img src="{{ $item['thumbnail'] }}" alt="{{ $item['name'] }}" width="100" height="90" />
                        </a>
                      </div>
                      <div class="unit-body">
                        ...
                        <div class="group-xs group-middle">
                          <div class="table-cart-stepper">
                            <input class="form-input" type="number" data-zeros="true" value="{{ $item['quantity'] }}" min="1" max="1000" />
                          </div>
